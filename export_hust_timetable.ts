class SubjectClass{
    public classId:String;//Mã lớp kèm -> Lớp lý thuyết, mã lớp -> lớp bài tập
    public classType:String;
    public name:String;
    public subjectId:String;
    public credit:String;
    constructor(_classId:String, _classType:String, _name:String, _subjectId:String, _credit:String){
        this.credit = _credit;
...
class LearningTime{
    ...
    public weeks:string;
    public place:string;
    constructor(_class:SubjectClass, _time:String, _dayOfWeek:string, _weeks:string, _place:string){
        this.class = _class;
        this.time = _time;
...
type SubjectClassDictionary = {
    [key: string]: SubjectClass;
};
var subjectClassDictionary:SubjectClassDictionary = {};
